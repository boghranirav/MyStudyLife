...
public class AdapterExamPastView extends ArrayAdapter<ClassExam>{

        Context context;
    public AdapterExamPastView(Context context, List<ClassExam> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if ((datecurrent.after(dateafter))) {
