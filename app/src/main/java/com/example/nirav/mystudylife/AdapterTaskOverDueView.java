...
public class AdapterTaskOverDueView extends ArrayAdapter<ClassTasks> {

        Context context;
    public AdapterTaskOverDueView(Context context, List<ClassTasks> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if ((datecurrent.after(dateafter)) && (Integer.parseInt(getItem(position).getT_completed()) < 100)) {
