...
public class BackgroundWorker extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url="https://mystudylife.000webhostapp.com/signup.php";
        if(type.equals("register")){
            try {
                ...
                String post_data= URLEncoder.encode("user_fname","UTF-8")+"="+URLEncoder.encode(user_fname,"UTF-8")+"&"
                        +URLEncoder.encode("user_lname","UTF-8")+"="+URLEncoder.encode(user_lname,"UTF-8")+"&"
        ...
        if(type.equals("login")){
            try {
                ...
                uname=user_name;
                URL url=new URL("https://mystudylife.000webhostapp.com/login.php");
                HttpURLConnection httpURLConnection= (HttpURLConnection) url.openConnection();
                httpURLConnection.setRequestMethod("POST");
                httpURLConnection.setDoOutput(true);
                httpURLConnection.setDoInput(true);
